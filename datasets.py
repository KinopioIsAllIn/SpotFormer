...
class LOSO_DATASET(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # TODO:change STEP to self._step
        STEP = self._step
        ...
        micro_start_end_label = [2] * (self._segment_len)  # 0->start, 1->end, 2->None
        macro_start_end_label = [2] * (self._segment_len)  # 0->start, 1->end, 2->None
        micro_apex_score = [0.] * (self._segment_len)
...
class CROSS_DATASET(data.Dataset):
...
if __name__ == "__main__":
    ...
    for (feature, micro_apex_score, macro_apex_score, score_action,
